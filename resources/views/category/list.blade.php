...
@section('content')
                    ...
                    <div class="box-body">
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <th class="text-center">Sl.</th>
                          ...
                          <th class="text-center">Meta Description At</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{$cat->meta_title }}</td>
                                <td class="text-center">{{$cat->meta_keywords }}</td>
                                <td class="text-center">{{$cat->meta_description }}</td>
                                <td class="text-center">
                                <a href=""><i class="fa fa-edit"></i> </a>
                                <a href="javascript:void(0)" onclick="showDeleteModal({{ $cat->id }})"><i class="fa fa-trash"></i> </a>
                                </td>
                            </tr>
                         @endforeach
                        </tbody>
    ...
    <div id="deleteModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
        <div class="bg-white p-4 rounded-lg w-96 text-center">
            ...
            <form id="deleteForm" method="POST" action="{{route('article.destroy',$cat->id)}}">
              @csrf
    ...
    function showDeleteModal(itemId) {
        ...
        document.getElementById('deleteForm').action = `/category/${itemId}`;
    }
